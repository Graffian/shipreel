...
const hook_generator_1 = require("./hook-generator");
async function generateScenePlan(input) {
    const hook = await (0, hook_generator_1.generateHook)({
...
function buildScenePlanPrompt(input, hook) {
...
async function queryLLM(prompt, hook) {
...
function fallbackResponse(hook) {
...
function parseLLMResponse(raw, hook) {
